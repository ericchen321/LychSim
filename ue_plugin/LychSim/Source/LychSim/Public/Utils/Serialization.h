...
public:
	...
	static TArray<uint8> Array2Npy(const TArray<FColor>& ImageData, int32 Width, int32 Height, int32 Channel);
	static TArray<uint8> Array2Npy4D(const TArray<TArray<FColor>>& ImageData, int32 Time, int32 Width, int32 Height, int32 Channel);
