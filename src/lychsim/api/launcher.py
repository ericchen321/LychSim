# https://github.com/unrealcv/unrealcv/blob/5.2/client/python/unrealcv/launcher.py
...
from lychsim.api.util import get_path2UnrealEnv
...
class RunUnreal:
    ...
    def set_ue_options(
        self, cmd_exe=[], opengl=False, offscreen=False, nullrhi=False, gpu_id=None
    ):
        """
...
class RunDocker:
    ...
    def start(
        ...
        docker_cmd = (
            "docker run --gpus all  -e DISPLAY=$DISPLAY -e SDL_VIDEODRIVER=x11"
