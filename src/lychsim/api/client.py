        ...
        try:
            ...
            if message is not None:
                if message.startswith(b"connected"):
                    ...
                    # daemon=True so the interpreter isn't kept alive by
                    # this thread if a caller forgets to call disconnect().
                    # Explicit disconnect() still shuts the thread down
                    # cleanly via the sentinel in recv_num_q.
